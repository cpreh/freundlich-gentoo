...
DEPEND="
	...
	=dev-games/spacegameengine-scm[audio,camera,cegui,config,console,fontbitmap,fonttext,image,image2d,input,line_drawer,parse,renderer,shader,sprite,systems,texture,time,window,viewport]
