...
DEPEND="
	...
	=dev-games/spacegameengine-9999[audio,cegui,charconv,config,console,font,fontdraw,image,image2d,input,log,parse,renderer,sprite,systems,texture,timer,viewport,window]
