...
src_unpack() {
	...
	epatch "${FILESDIR}/boost-1.37.0-fix_mpi_installation.patch"
	epatch "${FILESDIR}/boost-1.37.0-tools-build-fix.patch"
	epatch "${FILESDIR}/boost-1.37.0-function-template-compile-fix.patch"
